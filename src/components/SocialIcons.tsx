...
export default function SocialIcons({ small = false }) {
    ...
    // Hover effect: nhấc lên + shadow + blur
    const hoverEffect =
        "hover:-translate-y-0.5 hover:shadow-xl hover:backdrop-blur-xl";
    ...
    return (
        <div className="flex items-center gap-4">
            ...
            <a
                ...
                className={`${baseClasses} bg-black ${hoverEffect}`}
            >
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`${baseClasses} bg-[#1877F2] ${hoverEffect}`}
            >
                <svg className={svgSize} fill="white" viewBox="0 0 24 24">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`${baseClasses} bg-linear-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] ${hoverEffect}`}
            >
                <svg className={svgSize} fill="white" viewBox="0 0 24 24">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`${baseClasses} bg-[#0068FF] ${hoverEffect}`}
            >
                <svg
